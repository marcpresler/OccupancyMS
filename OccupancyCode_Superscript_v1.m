...
% 1) Data import  
% 2) Parameters
% 3) Estimate Site Occupancy and Determine CIs with Bootsrapping
% 4) Plot Data 
...
% Loads: 
% .xlxs file containing TMT signal for phos sites and matched nonphos peptides
% Normalization of the data is not necesssary, but helpful for plotting

% Column names in .xlsx file correpsonding to non-phos and phos-sites data are input by the users 
...
plot_fitting_scatter = 1;
    ...
    % Figure 1 is the NonPhos versus Phos Trends
...
A_optimal_occupancy_table = [occupancytrend_single_labeling,single_Phos_and_NON_phos(:,phospho_data_variables)...
    occupancytrend_array_table, Fit_confidence_higher_stored_single_array_table, Fit_confidence_lower_stored_single_array_table, single_Phos_and_NON_phos(:,peptide_data_variables)];
